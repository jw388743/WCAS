model = lm(
  StringChanges_train$Levenshtein_Distance ~ StringChanges_train$Fuzzy_Match_Score +
    StringChanges_train$Workflow_Step_Name + StringChanges_train$Target_Locale_ID + StringChanges_train$String_Word_Count +
    StringChanges_train$Translation_Character_Count + StringChanges_train$Translation_Updated_Percent +
...
model.beta = lm(
  StringChanges_train$Levenshtein_Distance ~ +StringChanges_train$Target_Locale_ID + StringChanges_train$String_Word_Count +
    StringChanges_train$Translation_Character_Count + StringChanges_train$Translation_Updated_Percent
)
summary(model.beta)
...
log.linear.mod = lm(
  log(StringChanges_train$Levenshtein_Distance) ~ StringChanges_train$Fuzzy_Match_Score +
    StringChanges_train$Workflow_Step_Name + StringChanges_train$Target_Locale_ID + StringChanges_train$String_Word_Count +
    StringChanges_train$Translation_Character_Count + StringChanges_train$Translation_Updated_Percent +
    StringChanges_train$Content_Type
)
...
log.linear.mod2 = log.linear.mod = lm(
  log(StringChanges_train$Levenshtein_Distance) ~ StringChanges_train$Fuzzy_Match_Score + StringChanges_train$Target_Locale_ID + StringChanges_train$String_Word_Count +
    StringChanges_train$Translation_Character_Count + StringChanges_train$Translation_Updated_Percent +
    StringChanges_train$Content_Type
)
...
log.linear.mod3 = log.linear.mod = lm(
  log(StringChanges_train$Levenshtein_Distance) ~ StringChanges_train$Fuzzy_Match_Score + StringChanges_train$Target_Locale_ID +
    StringChanges_train$Translation_Character_Count + StringChanges_train$Translation_Updated_Percent +
    StringChanges_train$Content_Type
)
